...
**									     **
**					EDIT:				     **
**		Switched from Comparable to Object so that objects	     **
**		may be sorted using Quick3WayBM.			     **
**									     **
******************************************************************************/

//Added for being able to bring in allSums!!!
import java.util.Comparator;

public class QuickXEdit {
    // ADDED!!!
    ...
    private static int median3(Object[] a, int i, int j, int k) {
        return (less(a[i], a[j]) ?
