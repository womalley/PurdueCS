...
module.exports = "<div class=\"container-fluid\">\n    <div class=\"row\">\n        <div class=\"col-md-2\">\n            <img class=\"float-left\" class=\"margin-top\" [src]=\"movie.image ? movie.image : '/assets/default.png'\" width=\"100%\" >\n        </div>\n        <div class=\"col-md-10\">\n            <div class=\"card\">\n                <div class=\"card-body\">\n                    <h5 class=\"display-3\">{{movie.title}}</h5>\n                    <div>\n                        <p> {{movie.logline}} </p>\n                        <p ><span *ngFor=\"let tags of movie.tags\">{{tags}} | </span></p>\n                        <p> <strong>Director:</strong> {{ movie.director}}</p>\n                        <p> <strong>Writers:</strong> {{ movie.screenwriters}}</p>\n                        <div>\n                            <span class=\"fa fa-star checked\"></span>\n                            <span class=\"fa fa-star checked\"></span>\n                            <span class=\"fa fa-star checked\"></span>\n                            <span class=\"fa fa-star\"></span>\n                            <span class=\"fa fa-star\"></span>\n                        </div>\n                    </div>\n                    <hr>\n                    <div class=\"lead\">\n                        <h5 class=\"display-4\"> Production Notes </h5>\n                        <p> Status: {{ movie.productionStatus}}</p>\n                    </div>\n                </div>\n            </div>\n            \n        </div>\n    </div>\n</div>"
...
var MovieDetailComponent = /** @class */ (function () {
    function MovieDetailComponent(route) {
        this.route = route;
        var movieId = +this.route.snapshot.params['id'];
    }
    ...
    MovieDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./movie-detail.component.html */ "./src/app/movie/movie-detail/movie-detail.component.html"),
            styles: [__webpack_require__(/*! ./movie-detail.component.css */ "./src/app/movie/movie-detail/movie-detail.component.css")]
        }),
...
module.exports = "<div class=\"container-fluid\">\n  <form [formGroup]=\"editForm\">\n      <label>Title</label>\n      <input type=\"text\" formControlName=\"title\" class=\"form-control\">\n      <label>Production Status</label>\n      <div *ngFor=\"let status of statuses\">\n        <input type=\"radio\" formControlName=\"productionStatus\" [value]=\"status\"> {{status}} \n      </div>\n      <label>Genre</label>\n      <input type=\"text\" formControlName=\"genre\" class=\"form-control\">\n      <label>Director</label>\n      <input type=\"text\" formControlName=\"director\" class=\"form-control\">\n      <label>Logline</label>\n      <input type=\"text\" formControlName=\"logline\" class=\"form-control\">\n      <label>Image</label>\n      <input type=\"url\" formControlName=\"image\" class=\"form-control\">\n      <button class=\"btn btn-outline-primary float-right\" [disabled]=\"!editForm.valid\" type=\"button\" (click)=\"update()\">Update</button>\n  </form>\n</div>\n"
...
/* harmony import */ var _shared_movie_util_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/movie-util.service */ "./src/app/shared/movie-util.service.ts");
...
var MovieEditComponent = /** @class */ (function () {
    function MovieEditComponent(fb, movieService, router, route) {
        this.fb = fb;
        ...
        this.editForm = this.fb.group({
            ...
            productionStatus: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
    ...
    MovieEditComponent.prototype.update = function () {
        var updatedMovie = __assign({}, this.editForm.value, { id: this.movie.id, tags: this.movie.tags });
    ...
    MovieEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./movie-edit.component.html */ "./src/app/movie/movie-edit/movie-edit.component.html"),
            styles: [__webpack_require__(/*! ./movie-edit.component.css */ "./src/app/movie/movie-edit/movie-edit.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _shared_movie_util_service__WEBPACK_IMPORTED_MODULE_2__["MovieUtilService"],
...
/***/ "./src/app/movie/movie-new/movie-new.component.css":
/*!*********************************************************!*\
  !*** ./src/app/movie/movie-new/movie-new.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = ".list-group-new {\r\n    max-height: 100px;\r\n    overflow-y: auto;\r\n}"

/***/ }),

/***/ "./src/app/movie/movie-new/movie-new.component.html":
/*!**********************************************************!*\
  !*** ./src/app/movie/movie-new/movie-new.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container-fluid\">\n  <form [formGroup]=\"newMovieForm\">\n      <label>Title</label>\n      <input type=\"text\" formControlName=\"title\" class=\"form-control\">\n      <label>Production Status</label>\n      <div *ngFor=\"let status of statuses\">\n        <input type=\"radio\" formControlName=\"productionStatus\" [value]=\"status\"> {{status}} \n      </div>\n      <label>Genre</label>\n      <input type=\"text\" formControlName=\"genre\" class=\"form-control\">\n      <label>Director</label>\n      <input type=\"text\" formControlName=\"director\" class=\"form-control\">\n      <label>Logline</label>\n      <input type=\"text\" formControlName=\"logline\" class=\"form-control\">\n      <label>Image</label>\n      <input type=\"url\" formControlName=\"image\" class=\"form-control\">\n      <div>\n        <label>Tags</label>\n        <ul class=\"list-group list-group-new\">\n          <li *ngFor=\"let tag of tags\" class=\"list-group-item\">{{tag}}</li>\n        </ul>\n        <input type=\"text\" formControlName=\"tags\" class=\"form-control\">\n        <button class=\"btn btn-primary\" (click)=\"addTag()\">Add Tag</button>\n      </div>\n      <div>\n      <label>Screenwriters</label>\n        <ul class=\"list-group list-group-new\">\n          <li *ngFor=\"let writer of writers\" class=\"list-group-item\">{{writer}}</li>\n        </ul>\n        <input type=\"text\" formControlName=\"screenwriters\" class=\"form-control\">\n        <button class=\"btn btn-primary\" (click)=\"addWriter()\">Add Writer</button>\n      </div>\n      <button class=\"btn btn-outline-primary float-right\" [disabled]=\"!newMovieForm.valid\" type=\"button\" (click)=\"addMovie()\">Add</button>\n  </form>\n</div>\n\n"

/***/ }),

/***/ "./src/app/movie/movie-new/movie-new.component.ts":
/*!********************************************************!*\
  !*** ./src/app/movie/movie-new/movie-new.component.ts ***!
  \********************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_movie_util_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/movie-util.service */ "./src/app/shared/movie-util.service.ts");
...
var MovieNewComponent = /** @class */ (function () {
    function MovieNewComponent(movieService, fb, router) {
        this.movieService = movieService;
        this.fb = fb;
        this.router = router;
        this.tags = [];
        ...
        this.newMovieForm = this.fb.group({
            ...
            productionStatus: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    MovieNewComponent.prototype.addMovie = function () {
        this.movieService.addMovie(__assign({ id: this.movieService.getMovies().length }, this.newMovieForm.value, { tags: this.tags.slice(), screenwriters: this.writers.slice() }));
        this.router.navigate(['']);
    };
    MovieNewComponent.prototype.addTag = function () {
        var newTag = this.newMovieForm.get('tags').value;
        this.tags.push(newTag);
        this.newMovieForm.get('tags').setValue('');
    };
    MovieNewComponent.prototype.addWriter = function () {
        var newWriter = this.newMovieForm.get('screenwriters').value;
    ...
    MovieNewComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./movie-new.component.html */ "./src/app/movie/movie-new/movie-new.component.html"),
            styles: [__webpack_require__(/*! ./movie-new.component.css */ "./src/app/movie/movie-new/movie-new.component.css")]
        }),
        __metadata("design:paramtypes", [_shared_movie_util_service__WEBPACK_IMPORTED_MODULE_1__["MovieUtilService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], MovieNewComponent);
...
/* harmony import */ var _movie_detail_movie_detail_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./movie-detail/movie-detail.component */ "./src/app/movie/movie-detail/movie-detail.component.ts");
/* harmony import */ var _movie_edit_movie_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./movie-edit/movie-edit.component */ "./src/app/movie/movie-edit/movie-edit.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _movie_new_movie_new_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./movie-new/movie-new.component */ "./src/app/movie/movie-new/movie-new.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'edit/:id', component: _movie_edit_movie_edit_component__WEBPACK_IMPORTED_MODULE_3__["MovieEditComponent"] },
    { path: 'new', component: _movie_new_movie_new_component__WEBPACK_IMPORTED_MODULE_6__["MovieNewComponent"] }
];
var MovieModule = /** @class */ (function () {
    ...
    MovieModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _movie_detail_movie_detail_component__WEBPACK_IMPORTED_MODULE_2__["MovieDetailComponent"],
                _movie_edit_movie_edit_component__WEBPACK_IMPORTED_MODULE_3__["MovieEditComponent"],
                _movie_new_movie_new_component__WEBPACK_IMPORTED_MODULE_6__["MovieNewComponent"],
            ],
            providers: []
        })
    ], MovieModule);
